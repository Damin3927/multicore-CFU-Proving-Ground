# File: riscv32-cfupg.mak
# TOOLCHAIN definition for CFU-PG Bare-Metal RISC-V Processor
#
...
COMPILER_DEFINES += USE_SINGLE_CONTEXT=0
...
LINKER_FLAGS += -Wl,--defsym,_num_cores=$(NCORES)
