...
int main(int argc, char **argv)
{
    ...
    win = XCreateSimpleWindow(display, RootWindow(display, DefaultScreen(display)), 0, 0, width,
                              height, 0, WhitePixel(display, DefaultScreen(display)),
